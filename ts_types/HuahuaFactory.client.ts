...
import {
  ...
  Token,
  TokenInfoResponse,
} from "./HuahuaFactory.types";
export interface HuahuaFactoryReadOnlyInterface {
  contractAddress: string;
  tokenInfo: ({ subdenom }: { subdenom: string }) => Promise<TokenInfoResponse>;
...
export class HuahuaFactoryQueryClient
  implements HuahuaFactoryReadOnlyInterface
{
...
export class HuahuaFactoryClient
  extends HuahuaFactoryQueryClient
  implements HuahuaFactoryInterface
{
